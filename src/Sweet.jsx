...
import './Sweet.css';
import Sweetmomo from  './Sweetmomo';
  ...
  <div className="modal-dialog" role="document">
    <div className="modal-content">
      <div className="modal-header">
        <h5 className="modal-title" id="exampleModalLabel">Sweet <ShoppingCartIcon /><span style={{fontSize : '15px', color : 'red'}}>{cart.length}</span></h5>
