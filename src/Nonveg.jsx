...
import './Nonveg.css';
import Nonvegmomo from './Nonvegmomo';
...
const pay = () =>{
  ...
  return (
    <>
    {
      ...
      <div>
    <p className="heading">NoNvEg MoMo</p>
    <span>
  ...
  <div className="modal-dialog" role="document">
    <div className="modal-content">
      <div className="modal-header">
        <h5 className="modal-title" id="exampleModalLabel">NonVeg <ShoppingCartIcon /><span style={{fontSize : '15px', color : 'red'}}>{cart.length}</span></h5>
