...
import Specialmomo from './Specialmomo';
import './Special.css';
...
const pay = () =>{
  ...
  return (
    <>
    {
      ...
      <div>
    <p className="heading">sPeCiAl MoMo</p>
     <span>
  ...
  <div className="modal-dialog" role="document">
    <div className="modal-content">
      <div className="modal-header">
        <h5 className="modal-title" id="exampleModalLabel">Special <ShoppingCartIcon /><span style={{fontSize : '15px', color : 'red'}}>{cart.length}</span></h5>
...
</div>
      {
        Specialmomo.map((momo , i) =>{
          return(
            ...
            <button className="btn" onClick={() => addtocart(momo)}>Add To Cart</button>
